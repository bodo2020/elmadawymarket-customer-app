...
تحديثات Flutter المرئية تُزامن مع مستودع العملاء المخصص. ملفات المصدر المرجعية قُرئت فقط، ولا migrations ولا تغيير RLS ولا Edge Functions ولا تعديل إعدادات Supabase تم تطبيقه.
